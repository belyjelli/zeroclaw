...
- Trong vòng lặp đã có hành vi liên quan compaction; bản ghi JSON phiên chưa phải câu chuyện persistence thống nhất.
...
**Tiêu chí thoát:** Khởi động lại và tiếp tục phiên; compaction giảm token đo được mà vẫn khôi phục được.
